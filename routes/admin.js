...
router.route('/block/:id', blockUser,authenticateUser,authorizePermissions('admin'))


router.route('/delete/:id', deleteUser,authenticateUser,authorizePermissions('admin'))
